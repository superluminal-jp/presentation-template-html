...
### DADS 公式コンポーネント(components.html)

デジタル庁DS公式サンプル(card / list / checkbox / progress-indicator / breadcrumb / radio)を固定コミットSHAから vendor 層へ取り込み、`components.html` のギャラリーで表示する(feature 006)。
